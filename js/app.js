...
app.controller('MainGanttCtrl', function($scope) {
  ...
  $scope.tasks = {
    data:[
      ...
      {id:4, text:"Company ", start_date:"25-01-2016", duration:4,order:10, open: true, color:"red"},
      ...
      {id:7, text:"Company ", start_date:"25-01-2016", duration:8,order:10, open: true, color:"orange"},
      ...
      {id:10, text:"Company ", start_date:"22-01-2016", duration:7,order:10, open: true, color:"green"},
      ...
      {id:13, text:"Company ", start_date:"1-02-2016", duration:5, order:10, open: true, color:"purple"},
      ...
      {id:19, text:"Company ", start_date:"25-01-2015", duration:7, order:10, open: true, color:"navy"},
